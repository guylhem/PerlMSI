...
my $sth = $dbh->prepare(<<SQL);
   ...
   UNION ALL
   select distinct on (acte) date_arrivee as acte_date, acte as acte_code_ccam, 0 as acte_phase, 1 as acte_activite, null as acte_ext_doc, 'DEFAULT' as acte_modificateur, 'DEFAULT' as acte_remb_exceptionnel, null as acte_assoc_nonprevue, 1 as acte_iteration from actes_rx_2007, rss_actes_2007, rss_2007
   where  rss_2007.code_sq_pk=rss_actes_2007.code_sq_fk and actes_rx_2007.iep='$iep' and  actes_rx_2007.iep=rss_actes_2007.iep and actes_rx_2007.acte!=rss_actes_2007.code_ccam and actes_rx_2007.date_arrivee <= rss_2007.date_sortie_uf and actes_rx_2007.date_arrivee>rss_2007.date_entree_uf group by actes_rx_2007.acte, actes_rx_2007.date_arrivee
SQL
