...
my $sth = $dbh->prepare(<<SQL);
   ...
   where  rss_2007.code_sq_pk=rss_actes_2007.code_sq_fk and actes_rx_2007.iep='$iep' and actes_rx_2007.iep=rss_actes_2007.iep and actes_rx_2007.acte != rss_actes_2007.code_ccam and actes_rx_2007.date_arrivee <= rss_2007.date_sortie_uf and actes_rx_2007.date_arrivee>rss_2007.date_entree_uf
   group by actes_rx_2007.acte, actes_rx_2007.date_arrivee
SQL
# rss_actes_2007.code_sq_fk in (select distinct code_sq_fk from rss_actes_2007 where iep='$iep' order by code_sq_fk limit 1)
